...
function copyProductImages() {
  const productBaseDir = path.join(
    assetsDir,
  ...
  const productMappings = [
    // Snacks
    {
      src: "Snacks & Munchies/Chips & Crisps/Lay's India's Magic Masala Potato Chips (40 g)/240092a.jpg",
      dest: "product-lays-magic-masala.jpg",
    },
    {
      src: "Snacks & Munchies/Chips & Crisps/Lay's American Style Cream & Onion Potato Chips/578b.jpg",
      dest: "product-lays-cream-onion.jpg",
    },
    {
      src: "Snacks & Munchies/Chips & Crisps/Kurkure Solid Masti Masala Twisteez Crisps/132817a.jpg",
      dest: "product-kurkure.jpg",
    },
    {
      src: "Snacks & Munchies/Bhujia & Mixtures/Haldiram's Nagpur Sev Bhujia/Haldiram's Nagpur Sev Bhujia.jpg",
      dest: "product-haldiram-sev.jpg",
    },
    {
      src: "Snacks & Munchies/Bhujia & Mixtures/Balaji Ratlami Sev Bhujia/Balaji Ratlami Sev Bhujia.jpg",
      dest: "product-balaji-sev.jpg",
    },
    {
      src: "Snacks & Munchies/Nachos/Doritos Cheese Nachos - Pack of 2/Doritos Cheese Nachos - Pack of 2.jpg",
      dest: "product-doritos.jpg",
    },
    {
      src: "Snacks & Munchies/Rusks & Wafers/Parle Real Elaichi Premium Rusk/Parle Real Elaichi Premium Rusk.jpg",
      dest: "product-parle-rusk.jpg",
    },
    {
      src: "Snacks & Munchies/Popcorn/Act II Butter Popcorn/Act II Butter Popcorn.jpg",
      dest: "product-act2-popcorn.jpg",
    },

    // Dairy
    {
      src: "Dairy, Bread & Eggs/Butter & More/Amul Salted Butter/Amul Salted Butter.jpg",
      dest: "product-amul-butter.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/Bread & Pav/Britannia Brown Bread/Britannia Brown Bread.jpg",
      dest: "product-britannia-bread.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/Curd & Yogurt/Amul Masti Curd/Amul Masti Curd.jpg",
      dest: "product-amul-curd.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/Curd & Yogurt/Mother Dairy Classic Curd/Mother Dairy Classic Curd.jpg",
      dest: "product-mother-dairy-curd.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/cheese/Amul Blend Diced Cheese/Amul Blend Diced Cheese.jpg",
      dest: "product-amul-cheese.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/Eggs/Table White White Eggs (10 pieces)/Table White White Eggs (10 pieces).jpg",
      dest: "product-eggs.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/Breakfast Mixes/MTR 3 Minute Poha Breakfast Mix - Pack of 5/488706a.jpg",
      dest: "product-mtr-poha.jpg",
    },
    {
      src: "Dairy, Bread & Eggs/Breakfast Mixes/MTR Upma Breakfast Mix/MTR Upma Breakfast Mix.jpg",
      dest: "product-mtr-upma.jpg",
    },

    // Atta/Rice
    {
      src: "Atta, Rice & Dal/Atta/Aashirvaad Superior MP Whole Wheat Atta/Aashirvaad Superior MP Whole Wheat Atta.jpg",
      dest: "product-aashirvaad-atta.jpg",
    },
    {
      src: "Atta, Rice & Dal/Atta/Fortune Chakki Fresh (100% Atta, 0% Maida) Atta/380156b.jpg",
      dest: "product-fortune-atta.jpg",
    },
    {
      src: "Atta, Rice & Dal/Rice/Daawat Pulav Basmati Rice (Slender Grains)/Daawat Pulav Basmati Rice (Slender Grains).jpg",
      dest: "product-daawat-rice.jpg",
    },
    {
      src: "Atta, Rice & Dal/Rice/India Gate Kolam Rice/India Gate Kolam Rice.jpg",
      dest: "product-india-gate-rice.jpg",
    },
    {
      src: "Atta, Rice & Dal/Moong & Masoor/Tata Sampann Unpolished Yellow Moong Dal (Dhuli) Split/57903b.jpg",
      dest: "product-tata-moong.jpg",
    },
    {
      src: "Atta, Rice & Dal/Poha, Daliya & Other Grains/Fortune Indori Thick Poha/Fortune Indori Thick Poha.jpg",
      dest: "product-fortune-poha.jpg",
    },
    {
      src: "Atta, Rice & Dal/Besan, Sooji & Maida/Rajdhani Besan (1 kg)/Rajdhani Besan (1 kg).jpg",
      dest: "product-rajdhani-besan.jpg",
    },
    {
      src: "Atta, Rice & Dal/Besan, Sooji & Maida/Tata Sampann 100% Chana Dal Fine BesanGram Flour/309447b.jpg",
      dest: "product-tata-besan.jpg",
    },
  ];
  ...
  files.forEach((file) => {
    ...
    if (
      ...
      subFiles.forEach((subFile) => {
        if (
          subFile.endsWith(".jpg") ||
          subFile.endsWith(".jpeg") ||
