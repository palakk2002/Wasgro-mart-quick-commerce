...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Aadekh - 10 Minute App", margin + 5, yPos + 10);
    ...
    doc.setFontSize(12);
    doc.setFont("helvetica", "bold");
    doc.text("Aadekh - 10 Minute App", margin, yPos);
    yPos += 7;

    doc.setFontSize(10);
    doc.setFont("helvetica", "normal");
    doc.text("From: Aadekh - 10 Minute App", margin, yPos);
    yPos += 6;
    doc.text("Phone: 8956656429", margin, yPos);
    yPos += 6;
    doc.text("Email: info@aadekh.com", margin, yPos);
    yPos += 6;
    doc.text("Website: https://aadekh.com", margin, yPos);
    yPos += 12;
    ...
    doc.text("Bill Generated by Aadekh - 10 Minute App", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 8;
    ...
    doc.setFontSize(8);
    doc.text(
      "Copyright © 2025. Developed By Aadekh - 10 Minute App",
      pageWidth / 2,
      yPos,
      { align: "center" }
    );
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-neutral-600 mb-1">
                <span className="font-medium">From:</span> Aadekh - 10 Minute App
              </div>
              <div className="text-sm text-neutral-600 space-y-1">
                ...
                <div>
                  <span className="font-medium">Email:</span> info@aadekh.com
                </div>
                <div>
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by Aadekh - 10 Minute App
            </p>
          </div>
        </div>
      </div>
