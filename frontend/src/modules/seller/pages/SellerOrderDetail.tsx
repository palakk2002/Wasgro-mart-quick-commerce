...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Wasgro mart - 10 Minute App", margin + 5, yPos + 10);
    ...
    doc.setFontSize(12);
    doc.setFont("helvetica", "bold");
    doc.text("Wasgro mart - 10 Minute App", margin, yPos);
    yPos += 7;

    doc.setFontSize(10);
    doc.setFont("helvetica", "normal");
    doc.text("From: Wasgro mart - 10 Minute App", margin, yPos);
    yPos += 6;
    doc.text("Phone: 8956656429", margin, yPos);
    yPos += 6;
    doc.text("Email: info@Wasgro mart.com", margin, yPos);
    yPos += 6;
    doc.text("Website: https://Wasgro mart.com", margin, yPos);
    yPos += 12;
    ...
    doc.text("Bill Generated by Wasgro mart - 10 Minute App", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 8;
    ...
    doc.setFontSize(8);
    doc.text(
      "Copyright © 2025. Developed By Wasgro mart - 10 Minute App",
      pageWidth / 2,
      yPos,
      { align: "center" }
    );
    ...
    <div className="min-h-screen bg-neutral-50 pb-8">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-neutral-600 mb-1">
                <span className="font-medium">From:</span> Wasgro mart - 10 Minute App
              </div>
              <div className="text-sm text-neutral-600 space-y-1">
                ...
                <div>
                  <span className="font-medium">Email:</span> info@Wasgro mart.com
                </div>
                <div>
                  <span className="font-medium">Website:</span>{" "}
                  https://Wasgro mart.com
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4 flex flex-col items-center">
            <div className="bg-teal-50 border border-teal-200 rounded-lg px-6 py-3 mb-4 w-full sm:w-auto">
              <div className="text-xs text-teal-600 font-semibold uppercase tracking-wider mb-1">Your Total Earning</div>
              <div className="text-2xl font-bold text-teal-800">₹{orderDetail.grandTotal.toFixed(2)}</div>
            </div>
            <p className="text-sm text-neutral-600">
              Bill Generated by Wasgro mart - 10 Minute App
            </p>
          </div>
        </div>
      </div>
