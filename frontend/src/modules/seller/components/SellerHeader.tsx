    ...
    <header className="bg-white shadow-sm border-b border-neutral-200 sticky top-0 z-30">
      <div className="flex flex-row items-center justify-between px-3 sm:px-4 md:px-6 py-2 sm:py-3">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button
            onClick={onMenuClick}
            className="hidden sm:block p-2 text-neutral-600 hover:text-neutral-900 transition-colors flex-shrink-0"
        ...
        {/* Mobile Action Icons - Location & Settings */}
        ...
        {showSettingsDropdown && (
          <div className="absolute right-3 top-14 w-48 bg-white rounded-lg shadow-lg border border-neutral-200 py-2 z-50 sm:hidden">
            <button
              onClick={() => {
                setShowSettingsDropdown(false);
        ...
        {showLocationDropdown && (
          <div className="absolute right-3 top-14 w-56 bg-white rounded-lg shadow-lg border border-neutral-200 py-2 z-50 sm:hidden">
