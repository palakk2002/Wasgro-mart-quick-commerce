      ...
      <div className="px-4 py-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Profile Icon */}
            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${isOnline ? 'bg-green-600' : 'bg-neutral-400'
              }`}>
          ...
          <button
            ...
            className={`relative w-12 h-6 rounded-full transition-colors ${isOnline ? 'bg-green-600' : 'bg-neutral-300'
              }`}
          >
            <div
